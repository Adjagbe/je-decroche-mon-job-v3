                ...
                <div className=" flex justify-center ">
                    <form className="grid grid-cols-1 gap-2 ">
                        ...
                        <div class="flex flex-row space-x-20">
                            <Link to="/pass_forgot"><div className='flex felx-row space-x-2'> <img src={key} className="w-4 h-5 pt-3" /> <div className="italic text-gray-600">  Mot de passe oublié ?</div> </div></Link>
